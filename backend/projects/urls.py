...
from .views import FAQDetailView, FAQListCreateView, KnowledgeBaseListView, IssueDetailView, IssueListCreateView, ProjectDetailView, ProjectListCreateView, ProjectAgentChatView
...
urlpatterns = [
    ...
    path("projects/agent/chat/", ProjectAgentChatView.as_view(), name="project-agent-chat"),
